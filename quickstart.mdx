...
<Steps>
  <Step title="Sign up at claw-link.dev">
    Go to [claw-link.dev](https://claw-link.dev) and create your account. New accounts start with a 7-day free trial — your first app is included, no card required.
  </Step>
