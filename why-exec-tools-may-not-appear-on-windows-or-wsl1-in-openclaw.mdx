...
> ![Warning icon](/images/icons/triangle-alert.svg)
> **Blunt version:** if you are on **WSL1**, treat that as the prime suspect early. Exec-heavy flows are much happier on **WSL2** or a normal Linux host.
...
## ![Warning icon](/images/icons/triangle-alert.svg) At a glance
